...
At DDPDOJ W181: **2,976 unit tests green** - 740 Batman, 725 Gradius, 1,511
...
`$90`, `$96`, `$8C`, `$91`, `$92`, `$97`, `$94`, and `$93` are ported. At W181
the ROM-backed registry reports 330 of 332 stage-2 records covered, with 2 records
remaining and zero dynamic entries outside the static inventory. The next
unsupported record is type `$86` at `$233018`.
