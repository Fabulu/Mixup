...
test('SECTION 2: `$246520` and `$24652A` are each claimed EXACTLY ONCE, and by the same file', () => {
  ...
  // see private functions, arrows and methods reports 74 after W470. SECTION 2d below and
...
test('SECTION 2d [W450/W470]: the widened register is 74, and this wave\'s three-copy constructor '
  ...
  assert.equal(wide.length, 74,
    'the widened duplicate register is not 74. ' + W453_NOTE
