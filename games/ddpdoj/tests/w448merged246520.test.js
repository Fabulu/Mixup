...
test('SECTION 2: `$246520` and `$24652A` are each claimed EXACTLY ONCE, and by the same file', () => {
  ...
  // see private functions, arrows and methods reports 83 after W463. SECTION 2d below and
...
test('SECTION 2d [W450/W463]: the widened register is 83, and this wave\'s three-copy constructor '
  ...
  assert.equal(wide.length, 83,
    'the widened duplicate register is not 83. ' + W453_NOTE
    ...
    + 'removed the private $28C0FC counted-note adapter row. '
