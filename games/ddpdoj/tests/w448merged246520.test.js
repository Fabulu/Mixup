...
test('SECTION 2: `$246520` and `$24652A` are each claimed EXACTLY ONCE, and by the same file', () => {
  ...
  // see private functions, arrows and methods reports 86 after W460. SECTION 2d below and
...
test('SECTION 2d [W450/W460]: the widened register is 86, and this wave\'s three-copy constructor '
  ...
  assert.equal(wide.length, 86,
    ...
    + 'W457 merged $25D9E6, W458 merged $25DA60, W459 merged $25FF38, and W460 '
    + 'removed the optional $24631C forwarding shim. The narrow count above sees only `export '
