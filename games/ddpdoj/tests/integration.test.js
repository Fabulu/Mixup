...
test('the handler adapter covers every address in handlerMap(), and only those',
  { skip: SKIP }, () => {
    ...
    assert.equal(m.size, 83, 'W25 ported six of stage 1\'s nineteen SCRIPT '
...
// ===========================================================================
test('TYPE5_PORTED is TWENTY-ONE of the twenty-three, and the list is the ROM\'s', () => {
