...
test('the handler adapter covers every address in handlerMap(), and only those',
  { skip: SKIP }, () => {
    ...
    assert.equal(m.size, 27, 'W25 ported six of stage 1\'s nineteen SCRIPT '
      ...
      + '$84 handler $2752B0, W174 adds $90 handler $279898, and W175 adds '
      + '$96 handler $27A548, so the map has 27 '
