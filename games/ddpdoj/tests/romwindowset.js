...
//
// ---------------------------------------------------------------------------
// TASK #237 WHITE BUTTON 2 ADDED TEN DISJOINT WINDOWS.
// ---------------------------------------------------------------------------
// The held-input hyper rows, bomb palettes, ordinary and laser bomb graphs,
// laser-bomb spark graph, and pending-hyper item template add 2,554 exact bytes.
// All ten lie below $200000 and are disjoint from every prior declaration.
...
// ---------------------------------------------------------------------------
// PRIVATE WHITE TYPE $10 ADDED NINE DISJOINT WINDOWS.
// ---------------------------------------------------------------------------
// The Build A type-table row, init stub, palette, two prototypes, three art
// tables, and kind-$0C template add 614 exact bytes below $200000.
...
// ---------------------------------------------------------------------------
// PRIVATE WHITE TYPE $05 AND TYPE $07 ALIAS ADDED FIVE DISJOINT WINDOWS.
// ---------------------------------------------------------------------------
// The two Build A type-table rows, Type $05 init stub, and its record and
// sub-record prototypes add 78 exact bytes below $200000. Type $05 reuses the
// already exported damage-first art, aim, fire, score, effect, and bullet data;
// Type $07 aliases Type $27's existing init and handler exactly.
...
// ---------------------------------------------------------------------------
// TASK #275 PRIVATE WHITE TYPE $8B ADDED EIGHT DISJOINT WINDOWS.
// ---------------------------------------------------------------------------
// The Build A Pool-B kind-$01 route, Type $8B initialization and prototypes,
// high type-table row, and Pool-A kind-$08 pointer/template add 164 exact
// bytes below $200000. Several windows abut existing declarations, but no
// pair overlaps.
// Measured: 1792 -> 1800 windows, 659,565 -> 659,729 bytes, and 79 -> 79
// overlapping pairs.

// ---------------------------------------------------------------------------
// TASK #276 PRIVATE WHITE TYPE $20 FAMILY ADDED THREE DISJOINT WINDOWS.
// ---------------------------------------------------------------------------
// The Build A low type-table cells, initializer stub, and sub-record prototype
// add 68 exact bytes below $200000. No new pair overlaps.
...
// ---------------------------------------------------------------------------
// TASK #280 PRIVATE WHITE TYPE $89 ADDED NINE DISJOINT WINDOWS.
// ---------------------------------------------------------------------------
// The Build A heading-art and paired-fan tables, initializer stub, palette and
// prototypes, high type-table row, and kind-$06 bullet pointer, template, and
// behavior cells add 480 exact bytes below $200000. No new pair overlaps.
// Measured: 1824 -> 1833 windows, 661,945 -> 662,425 bytes, 870 -> 879 unique
// White windows, 204,148 -> 204,628 White bytes, and 80 -> 80 overlap pairs.

// ---------------------------------------------------------------------------
// TASK #281 PRIVATE WHITE TYPE $88 ADDED SEVEN DISJOINT WINDOWS.
// ---------------------------------------------------------------------------
// The Build A heading-art and fan-vector tables, initializer stub, palette,
// prototypes and cue data, sprite and death-drop vectors, register-emitter
// dispatch, and high type-table row add 506 exact bytes below $200000. No new
// pair overlaps.
...
// ---------------------------------------------------------------------------
// TASK #284 PRIVATE WHITE TYPE $0B ADDED FOUR DISJOINT WINDOWS.
// ---------------------------------------------------------------------------
// The Build A low type-table row, initializer stub, enemy-record prototype,
// and sub-record prototype add 66 exact bytes below $200000. No new pair
// overlaps.
// Measured: 1844 -> 1848 windows, 662,997 -> 663,063 bytes, 890 -> 894 unique
// White windows, 205,200 -> 205,266 White bytes, and 80 -> 80 overlap pairs.

// ---------------------------------------------------------------------------
// TASK #285 PRIVATE WHITE TYPE $09 ADDED FOUR DISJOINT WINDOWS.
// ---------------------------------------------------------------------------
// The Build A low type-table row, initializer stub, enemy-record prototype,
// and sub-record prototype add 66 exact bytes below $200000. No new pair
// overlaps.
// Measured: 1848 -> 1852 windows, 663,063 -> 663,129 bytes, 894 -> 898 unique
// White windows, 205,266 -> 205,332 White bytes, and 80 -> 80 overlap pairs.

// ---------------------------------------------------------------------------
// TASK #286 PRIVATE WHITE TYPE $24 ADDED FIVE DISJOINT WINDOWS.
// ---------------------------------------------------------------------------
// The Build A palette block, low type-table row, initializer stub, sub-record
// prototype, and sprite table add 172 exact bytes below $200000. No new pair
// overlaps.
// Measured: 1852 -> 1857 windows, 663,129 -> 663,301 bytes, 898 -> 903 unique
// White windows, 205,332 -> 205,504 White bytes, and 80 -> 80 overlap pairs.

// ---------------------------------------------------------------------------
// TASK #288 PRIVATE WHITE TYPE $31 ADDED EIGHT DISJOINT WINDOWS.
// ---------------------------------------------------------------------------
// Two Build A palette blocks, the record-convention emitter, low type-table
// row, initializer stub, two palette-bank tables, contiguous record and
// sub-record prototypes, and the 70-entry animation table add 786 exact bytes
// below $200000. The 40-byte prototype window is required because the final
// longword read at $168860 cannot cross an abutting seam. No new pair overlaps.
...
export const OVERLAP_NOTE = `${ROM_OVERLAP_PAIRS} overlapping pairs over the `
  ...
  + "and moved no overlap pair. Task #237 added ten disjoint White Button 2 and "
  + "bomb windows totalling 2,554 bytes and moved no overlap pair. See "
