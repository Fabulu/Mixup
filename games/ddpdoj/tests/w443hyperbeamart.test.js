...
{ skip: SKIP_TABLES }, () => {
  ...
  // W551-W553 add unrelated data windows; no beam window moves.
  assert.equal(ROM_WINDOW_COUNT, 812,
    'W497 and W500-W553 reconcile the current exact RomWindows registry');
