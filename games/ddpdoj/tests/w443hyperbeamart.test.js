...
{ skip: SKIP_TABLES }, () => {
  ...
  // W551-W554 add unrelated data windows; no beam window moves.
  assert.equal(ROM_WINDOW_COUNT, 813,
    'W497 and W500-W554 reconcile the current exact RomWindows registry');
