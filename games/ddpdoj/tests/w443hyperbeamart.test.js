...
{ skip: SKIP_TABLES }, () => {
  ...
  // W551-W555 add unrelated data windows; no beam window moves.
  assert.equal(ROM_WINDOW_COUNT, 814,
    'W497 and W500-W555 reconcile the current exact RomWindows registry');
