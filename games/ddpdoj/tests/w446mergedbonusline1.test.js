...
// Narrow remains 16 while the widened figure moves to 76.
test('SECTION 2c [W450/W469]: the widened register is 76, so narrow 16 remains a floor', async () => {
  ...
  assert.equal(headRegister().length, 76,
    ...
    + 'span, not just `export function`) is not 76. ' + W453_NOTE
    ...
    + 'removed both private $28C0FC counted-note adapter heads; W464 through W469 removed '
    + '$28E7A2, $28C6C6, $28F4C4/$28F666, $285A12, $2A6EDC, and $23C622 adapter claims; '
