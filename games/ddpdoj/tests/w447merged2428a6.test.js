...
// to `portedIndex()` on every axis it has. The widened scan is 85 (92 at W450,
// minus $242684 at W451, $242494 at W453, $25D9E6 at W457, $25DA60 at W458,
// $25FF38 at W459, the optional $24631C shim at W460 and the private $242E24
// rank-byte body at W461). See
...
test('SECTION 6b [W450/W461]: the widened register is 85, and this wave\'s two merges hold under it too',
  async () => {
    ...
    assert.equal(wide.length, 85,
      ...
      + '$242E24 rank-byte body into rng.js drawByte242E24; '
