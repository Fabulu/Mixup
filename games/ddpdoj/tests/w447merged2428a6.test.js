...
test('SECTION 6: the doubly-claimed register is 15, and all later proved merges are ABSENT '
  ...
  assert.equal(dup.includes(0x28d520), false,
    '$28D520 is singly claimed after W474 made the retired ledger note address-free');
});
...
test('SECTION 6b [W450/W474]: the widened register is 69, and this wave\'s two merges hold under it too',
  async () => {
