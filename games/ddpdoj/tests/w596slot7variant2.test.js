...
const TABLE_HASH = '8854b7ebbc400795e7bcc7cf401e4f4d762220333ccbc6df9e1cf0c4b5ca5f5f';
...
const CHECKPOINT_RAM_HASH = '1520e6aa6cc04eb8ce111be222816a2404f2ca5535c82846fdcf8f1ce8095707';
const CHECKPOINT_GAME_HASH = 'a92e682a71ff2eb5b3d4d2eb3b0035a7bcfbbbd0fc5366fdaf9550f194440115';
...
test('W596 exports only the exact variant-2 script and sole missing dependency',
  { skip: SKIP }, () => {
    ...
    ], [PRIOR_TABLE_HASH, 906, 453757, 77]);
...
test('W596 fresh ship-0/style-6 route pins every cadence identity and stops at W597',
  { skip: SKIP }, async () => {
    ...
    assert.deepEqual(EXPECTED.tables, {
      sha256: TABLE_HASH, windows: 908, bytes: 453851, overlapPairs: 77,
    });
