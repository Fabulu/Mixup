...
test('SECTION 3: one `$242684` claimant survives, and all six old private heads are gone', () => {
  ...
  assert.equal(headRegister().length, 86,
    'W450 92 minus $242684 at W451, $242494 at W453, $25D9E6 at W457, $25DA60 at W458, $25FF38 at W459 and $24631C at W460 is 86');
  assert.equal(pairs.length, 28,
    'W450 39 body pairs minus W451 $242684, W453 $242494, W454 turret, W455 '
      + 'beam reset, four W456 item-velocity edges, W457 cursor map, W458 cursor load and W459 request poster is 28');
});
