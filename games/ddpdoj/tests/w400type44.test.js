...
test('W400 SECTION 8: the window set, an overlap count these eight do not move, and all '
  + 'eight sit in open ground',
  { skip: SKIP }, () => {
    const ws = WINDOWS();
    assert.equal(ws.length, ROM_WINDOW_COUNT, '575 windows before this wave, 583 after; 585 after W402, 590 after W404, 593 after W405, 594 after W406, 595 after W407, 596 after W408 and 599 since W409 added A4 script 5\'s three blocks; W408 added '
    ...
    assert.equal(overlappingPairs(ws.filter(([a]) => !mine.includes(a))), ROM_OVERLAP_PAIRS,
      '...and the SAME count without them: none of the eight overlaps anything. The '
