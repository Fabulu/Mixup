...
const CADENCE = 500;
const CURRENT_TABLE_HASH = '7949abd7bcdc090d86abf5e3c79487bdd4ae6f4c5e7d6bfaaa2368a71a3e5437';
...
test('W595 is one exact BIOS-window widening and reconstructs the $000BEC fault',
  { skip: SKIP }, () => {
    ...
    assert.deepEqual(EXPECTED.tables, {
      sha256: CURRENT_TABLE_HASH, windows: 1006, bytes: 478353, overlapPairs: 77,
    });
