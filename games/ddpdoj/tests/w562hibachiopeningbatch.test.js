...
const PRIOR_HASH = '296791ca69128537e41986036eccf0fd7b3cbf8c5070c04cb0e1a6eda545c835';
const FUTURE_HASH = '075256275a618e2614c019647b822f59bd6cfa0f773b598b9bf81ac8af1bd6cb';
const CHECKPOINT_TABLE_HASH = '9de98bc04d936cf87af379a625ab765283766ab7103754c3acef6aad356d5176';
const STORED_PRIOR_HASH = 'a5f07d6642229fb7590fb453b721b0bd30304b73699d78706b0fc2ca2452645a';
const STORED_FUTURE_HASH = '8fd6f588388e32cbdd945f323028c8e482196edf50340ed3d5077e24479cbdac';
const RECONSTRUCTED_STORED_CHECKPOINT_HASH =
  '54f93cf0111699032fa3ed01ecc86ed160795df806452a92203e59efd3672b15';
...
test('W562 is exactly four disjoint additive windows and $16A bytes', { skip: SKIP }, () => {
  ...
  assert.equal(W562_TABLE.rom.windows.length, 822);
  ...
  assert.equal(ROM_OVERLAP_PAIRS, 80, 'the live table includes three later shared overlaps');
...
test('W562 future-window checkpoint reaches gun 1 template as the W563 window seam',
  { skip: SKIP_CHECKPOINT }, async () => {
    ...
    ], [822, RECONSTRUCTED_STORED_CHECKPOINT_HASH, STORED_CHECKPOINT_TABLE_HASH]);
