...
test('W408 SECTION 7: ONE new window, 596, bounded three ways and none of them an absence',
  { skip: SKIP }, () => {
...
test('W408 SECTION 7: the ported and counted lists still add up to the whole table',
  { skip: SKIP }, () => {
    ...
    assert.deepEqual(Object.keys(HIBACHI_A1_COUNTED).map(Number), [0, 1, 2, 3, 4, 0x0c, 0x0d],
      '  ...leaving seven counted');
