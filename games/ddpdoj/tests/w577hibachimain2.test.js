...
test('W577 restores the exact lf148131 checkpoint and reaches A0 id 3 through W580',
  { skip: SKIP_CHECKPOINT }, async () => {
    ...
    let error = null;
    let attempted = 0;
    for (attempted = 1; attempted <= 2300; attempted++) {
      try {
    ...
    ], [2266, 150396, 161010, 0x2a50d0, 4, 1, 0x81533c, 4]);
