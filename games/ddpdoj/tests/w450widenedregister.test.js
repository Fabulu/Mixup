...
//
// ---------------------------------------------------------------------------
// THE NUMBER WAS 19, W450 FOUND 92, W451 LEFT 91, W453 LEFT 90, W457 LEFT 89, W458 LEFT 88, W459 LEFT 87, W460 LEFT 86, W461 LEFT 85, W462 LEFT 84, W463 LEFT 83, W464 LEAVES 82
// ---------------------------------------------------------------------------
...
// THE HEAD REGISTER. 82 ROM addresses claimed by two or more function-like
...
//     to it, removing the second identical 40-word loop and leaving 82. Next sharpest
//     is `$28C6C6`, followed by `$28F4C4`, `$285A12` and `$2A6EDC`.
//
...
test('SECTION 3: the widened head register is exactly these 82 addresses', () => {
  ...
  assert.equal(wide.length, 82,
    'the widened register is not 82. W450 found 92, W451 merged $242684, W453 merged '
    ...
    + '$28C0FC counted-note adapter row, then W464 merged the duplicate $28E7A2 clear');
