...
test('W578 restores lf148631 and reaches the exact A0 id-3 frontier through W580',
  { skip: SKIP_CHECKPOINT }, async () => {
    ...
    let error = null;
    let attempted = 0;
    for (attempted = 1; attempted <= 1800; attempted++) {
      try {
    ...
    ], [1766, 150396, 161010, 0x2a50d0, 4, 1, 0x81533c, 4]);
