...
test('W584 migrated checkpoints restore exactly and reach the W586 loud frontier',
  { skip: SKIP_CHECKPOINT }, async () => {
    ...
    let error = null;
    let attempted = 0;
    for (attempted = 1; attempted <= 1400; attempted++) {
      try {
    ...
    assert.deepEqual([
      ...
      1211, 151841, 162479, 0x242748, 4, 8, 16, 1,
