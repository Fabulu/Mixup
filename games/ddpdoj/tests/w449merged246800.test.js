...
test('SECTION 2: `$246800` is claimed EXACTLY ONCE, and the live register is at 16', () => {
  ...
  assert.equal(dup.length, 16,
    'W474 left 15 and W497 registered the authentic-selection adapter at $2491C0. '
...
test('SECTION 2e [W450/current]: the widened register is 71, and $246800 is claimed once under IT too',
  async () => {
