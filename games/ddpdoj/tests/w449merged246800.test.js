...
test('SECTION 2e [W450/W554]: the widened register is 72, and $246800 is claimed once under IT too',
  async () => {
    ...
    assert.equal(wide.length, 72,
      ...
      + '$253D82/$253D90; W554 adds the shared $2A54E2 A3 selector row; '
