...
test('SECTION 2e [W450/W468]: the widened register is 77, and $246800 is claimed once under IT too',
  async () => {
    const { headRegister, bodyPairs } = await import('./w450widenedscan.js');
    const wide = headRegister();
    assert.equal(wide.length, 77,
      'the widened duplicate register is not 77. ' + W453_NOTE
