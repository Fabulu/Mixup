...
test('SECTION 2: `$246800` is claimed EXACTLY ONCE, and the register is at 19', () => {
  ...
  assert.equal(dup.length, 19,
    'W446 counted 24, W447 merged two (22), W448 merged two more (20), W449 merges $246800 (19). '
