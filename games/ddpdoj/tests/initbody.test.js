...
test('the Stage-1 through W211 Stage-4 bodies are dispatched', () => {
  ...
  assert.equal(INIT_BODY_ADDRESSES.length, 58,
    ...
    + `W203's $266D36, W207's $29EAE2, W209's $29E580, and W211's $27896A`);
});
