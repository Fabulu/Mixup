...
test('the stage-1 bodies and W170-W185 stage-2 bodies are all dispatched', () => {
  ...
  assert.equal(INIT_BODY_ADDRESSES.length, 36,
    ...
    + `W182's $275BB6, W183's $297120, and W185's $29BB26`);
});
