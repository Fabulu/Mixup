...
test('the stage-1, Stage-2, and W195 Stage-3 bodies are dispatched', () => {
  ...
  assert.equal(INIT_BODY_ADDRESSES.length, 40,
    ...
    + `W193's $263A58, W194's $264740, and W195's $266968`);
});
