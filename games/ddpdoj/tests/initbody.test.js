...
test('the stage-1 bodies and W170-W181 stage-2 bodies are all dispatched', () => {
  ...
  assert.equal(INIT_BODY_ADDRESSES.length, 33,
    ...
    + `W178's $279CD0, W179's $277DE8, W180's $27A0E8, and W181's $279EC2`);
});
