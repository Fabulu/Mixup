...
test('the stage-1 bodies and W170-W176 stage-2 bodies are all dispatched', () => {
  ...
  assert.equal(INIT_BODY_ADDRESSES.length, 28,
    ...
    + `W174's $27980A, W175's $27A454, and W176's $2789F6`);
});
