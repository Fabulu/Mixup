...
test('the stage-1 bodies and W170-W177 stage-2 bodies are all dispatched', () => {
  ...
  assert.equal(INIT_BODY_ADDRESSES.length, 29,
    ...
    + `W174's $27980A, W175's $27A454, W176's $2789F6, and W177's $279AA2`);
});
