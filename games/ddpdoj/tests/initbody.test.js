...
test('the stage-1, Stage-2, and W203 Stage-3 bodies are dispatched', () => {
  ...
  assert.equal(INIT_BODY_ADDRESSES.length, 57,
    ...
    + `W203's $266D36, W207's $29EAE2, and W209's $29E580`);
});
