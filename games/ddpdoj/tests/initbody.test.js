...
test('the stage-1, Stage-2, and W196 Stage-3 bodies are dispatched', () => {
  ...
  assert.equal(INIT_BODY_ADDRESSES.length, 41,
    ...
    + `W193's $263A58, W194's $264740, W195's $266968, and W196's $264D5A`);
});
