...
test('the stage-1, Stage-2, and W192 opening Stage-3 bodies are dispatched', () => {
  ...
  assert.equal(INIT_BODY_ADDRESSES.length, 37,
    ...
    + `W182's $275BB6, W183's $297120, W185's $29BB26, and W192's $2653EE`);
});
