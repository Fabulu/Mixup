...
Updated 2026-08-22 after Wave 497 local verification. W496 remains the live build.
...
At W497, `export-web.mjs` regenerated a 12,623.9 KiB local bundle containing 4,898 validated sprite streams, including 33 ship-bank streams and 85 Type-B attached shadow/glow streams, and 161 captured frames with 7,671 records. The 735.6 KiB first-frame set and 11,888.4 KiB deferred set include every cartridge-selected regular-laser group and both ships' ordinary-bomb and laser-bomb art. `rip/` and `assets/` are ROM-derived, gitignored, and must not be committed.
