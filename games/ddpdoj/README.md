...
Updated 2026-08-22 after Wave 486 publication.
...
| tests | W486's focused type `$4C` arm, runtime, field, and retirement set passes 96/96. Its red switches fail when the step-1 gate is bypassed or the child type is mutated. The published W486 gate passed all `4,310` DDPDOJ unit tests with no failures or skips. |
...
| live build | `20260822042005` at <https://gbtman.pages.dev/games/ddpdoj/> supersedes `20260822010546`. W487 continues with runtime-proven type `$58`. |
