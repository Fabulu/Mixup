...
export const HIBACHI_A1_ALT_SCRIPTS = Object.freeze([0]);
...
/** The four still-unported ids unique to `$2A92A8`'s loop-zero table. W562 runs
 *  id 0; only the FIRST loop ($813098 == 0) can dispatch any of these five ids. */
