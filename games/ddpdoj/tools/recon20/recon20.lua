...
TAPS[#TAPS + 1] = PROG:install_write_tap(0x817F8C, 0x81B40B, "spawn", function(offset, data, mask)
  ...
  if pc == 0x28158A then onspawn("2814B6")
  elseif pc == 0x281898 then onspawn("2817C2") end
  return data
end)
