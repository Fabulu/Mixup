...
ENTRIES = {
    # bank A -- angle in 1/64 turn, scaled x4 inside $281554
    0x2813F0: ("A_single",         1),
    0x281402: ("A_single_sp+4",    1),
    0x281420: ("A_pair_sp+6",      2),
    0x281432: ("A_triple_sp+5",    3),
    0x281442: ("A_spread2",        2),
    0x281450: ("A_spread2_sp+4",   2),
    0x281484: ("A_spread3",        3),
    0x281494: ("A_pair_sp+4",      2),
    0x2814AC: ("A_adaptive",       1),
    0x2814B6: ("A_core",           1),
    # bank B -- angle ALREADY in 1/256 turn, cores are $2817C2
    0x2816F6: ("B_single",         1),
    0x281708: ("B_single_sp+4",    1),
    0x281726: ("B_single_sp+2",    1),
    0x281744: ("B_pair_sp+6",      2),
    0x281754: ("B_triple_sp+5",    3),
    0x281764: ("B_spread2",        2),
    0x281776: ("B_spread2_sp+6",   2),
    0x2817A8: ("B_spread3",        3),
    0x2817B8: ("B_adaptive",       3),
    0x2817C2: ("B_core",           1),
}
